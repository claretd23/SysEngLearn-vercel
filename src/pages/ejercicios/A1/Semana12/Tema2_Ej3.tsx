...
export default function Tema2_Ej3() {
  ...
  const ejercicios: MCQ[] = useMemo(() => [
    {
      audios: ["/audios/sem12/11a.mp3", "/audios/sem12/11b.mp3"],
