...
export default function Tema2_Ej2() {
  ...
  const ejercicios = [
    {
      texto: "My best friend is very _________. (friendly / lazy)",
      correcta: ["friendly"],
    },
    {
      texto: "The movie isn’t _________. It’s boring! (interesting / sad)",
      correcta: ["interesting"],
    },
    {
      texto: "__________ your teacher _________? (Is / strict)",
      correcta: ["Is your teacher strict?"],
    },
    {
      texto: "This restaurant is really _________. (expensive / cheap)",
      correcta: ["cheap"],
    },
    {
      texto: "Our neighborhood isn’t _________. It’s dangerous at night. (safe / noisy)",
      correcta: ["safe"],
    },
    {
      texto: "My little sister is very _________. She always smiles. (cheerful / rude)",
      correcta: ["cheerful"],
    },
    {
      texto: "The hotel wasn’t _________. It was dirty and old. (clean / comfortable)",
      correcta: ["clean"],
    },
    {
      texto: "__________ your new coworkers _________? (Are / nice)",
      correcta: ["Are your new coworkers nice?"],
    },
    {
      texto: "The beach is _________ today! Let’s go swimming! (beautiful / terrible)",
      correcta: ["beautiful"],
    },
    {
      texto: "My phone isn’t _________ enough to play that game. (fast / heavy)",
      correcta: ["fast"],
    },
  ];
      ...
      {!finalizado ? (
        <>
          ...
          <section className="tarjeta-ejercicio" style={{ textAlign: "center" }}>
            ...
            {!respuesta && (
              <div className="opciones-ejercicio" style={{ display: "flex", justifyContent: "center", gap: "1rem", margin: "1.5rem 0" }}>
                <input
                  type="text"
                  value={inputValue}
