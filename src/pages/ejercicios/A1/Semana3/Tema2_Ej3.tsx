...
export default function Tema3_Ej2() {
  ...
  const ejercicios = [
    ...
    { texto: "John is from Japan. He is ______.", correcta: ["Japanese"] },
  ];
          ...
          <section className="tarjeta-ejercicio" style={{ textAlign: "center" }}>
            ...
            <div style={{ margin: "1rem 0" }}>
              <button
                onClick={playAudio}
                className="btn-audio"
                style={{ fontSize: "1.5rem", padding: "0.5rem 1rem", borderRadius: "8px" }}
              >
                🔊 Play Audio
              </button>
              <audio ref={audioRef} src="/audios/sem1/Tema3/friends_nationalities.mp3" />
            </div>
