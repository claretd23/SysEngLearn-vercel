...
export default function Tema2_Ej1() {
  ...
  const ejercicios = [
    ...
    { texto: "My father’s sister is my _______. ", correcta: ["aunt"] },
    { texto: "My aunt’s son is my _______.", correcta: ["cousin"] },
    { texto: "My sister’s daughter is my _______. ", correcta: ["niece"] },
    { texto: "My brother’s son is my _______.", correcta: ["nephew"] },
    { texto: "My mother’s father is my _______. ", correcta: ["grandfather"] },
    { texto: "My father’s mother is my _______.", correcta: ["grandmother"] },
    { texto: "My parents’ son is my _______. ", correcta: ["brother"] },
    { texto: "My parents’ daughter is my _______. ", correcta: ["sister"] },
  ];
            ...
            {index === 0 && (
              <div className="instruccion-box">
                <p className="instruccion-ejercicio" style={{ fontSize: "1.3rem" }}>
                  Complete each sentence with the correct <b>family word</b>.
                </p>
              </div>
            )}
