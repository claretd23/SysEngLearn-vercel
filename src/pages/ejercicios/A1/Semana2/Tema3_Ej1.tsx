...
export default function Tema3_Ej1() {
  ...
  const ejercicios = [
    ...
    { texto: "They ___ students.", correcta: "are" },
    { texto: "He ___ a doctor.", correcta: "is" },
    { texto: "We ___ happy.", correcta: "are" },
    { texto: "You ___ my friend.", correcta: "are" },
    { texto: "My mother ___ at home.", correcta: "is" },
    { texto: "I ___ a teacher.", correcta: "am" },
    { texto: "The dog ___ small.", correcta: "is" },
    { texto: "They ___ brothers.", correcta: "are" },
  ];
            ...
            {index === 0 && (
              <div className="instruccion-box">
                <p className="instruccion-ejercicio" style={{ fontSize: "1.3rem" }}>
                  Select the correct form of the verb <b>to be</b> (am / is / are).
                </p>
              </div>
            )}
