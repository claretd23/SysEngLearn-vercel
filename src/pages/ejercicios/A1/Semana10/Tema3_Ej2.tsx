...
export default function Tema3_Ej2() {
  ...
  const ejercicios = [
    ...
    { texto: "He _______ drive a car. ", correcta: ["can’t"] },
    { texto: "We _______ come to the party tonight. ", correcta: ["can"] },
    { texto: "You _______ smoke here. ", correcta: ["can’t"] },
    { texto: "They _______ solve this problem. ", correcta: ["can"] },
    { texto: "My brother _______ play the piano. ", correcta: ["can"] },
    { texto: "I _______ lift this heavy box alone. ", correcta: ["can’t"] },
    { texto: "She _______ eat spicy food. ", correcta: ["can"] },
    { texto: "We _______ enter the room without a permission. ", correcta: ["can’t"] },
  ];
            ...
            {index === 0 && (
              <div className="instruccion-box">
                <p className="instruccion-ejercicio" style={{ fontSize: "1.3rem" }}>
                  Complete the sentences using <b>can</b> or <b>can’t</b>.
                </p>
              </div>
            )}
