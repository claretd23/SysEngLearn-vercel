...
export default function Tema1_Ej1() {
  ...
  const ejercicios = [
    ...
    { texto: "Look at _______ car over there!", correcta: ["that"] },
    { texto: "_______ apples on the table are fresh.", correcta: ["Those"] },
    { texto: "I don’t like _______ color on the wall.", correcta: ["that"] },
    { texto: "Are _______ your keys on the sofa?", correcta: ["those"] },
    { texto: "_______ is my best friend, Laura.", correcta: ["This"] },
    { texto: "_______ books belong to my teacher.", correcta: ["These"] },
    { texto: "What’s _______ noise outside?", correcta: ["that"] },
    { texto: "_______ flowers in your garden are beautiful.", correcta: ["Those"] },
  ];
            ...
            {index === 0 && (
              <div className="instruccion-box">
                <p className="instruccion-ejercicio" style={{ fontSize: "1.3rem" }}>
                  Complete each sentence with <b>this, these, that, or those</b>.
                </p>
              </div>
            )}
