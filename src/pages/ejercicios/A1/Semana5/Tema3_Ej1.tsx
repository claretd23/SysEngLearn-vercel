...
export default function Tema3_Ej1() {
  ...
  const ejercicios = [
    { pregunta: "I go to school ______ bus.", opciones: ["in", "on", "by"], correcta: "by" },
    { pregunta: "She is sitting ______ the taxi.", opciones: ["on", "in", "by"], correcta: "in" },
    { pregunta: "We are traveling ______ a plane to London.", opciones: ["on", "in", "by"], correcta: "on" },
    { pregunta: "My father goes to work ______ car.", opciones: ["in", "on", "by"], correcta: "by" },
    { pregunta: "They are ______ the train right now.", opciones: ["in", "on", "by"], correcta: "on" },
    { pregunta: "He arrived ______ a helicopter.", opciones: ["on", "in", "by"], correcta: "in" },
    { pregunta: "We go to the beach ______ boat every summer.", opciones: ["by", "on", "in"], correcta: "by" },
    { pregunta: "Are you going ______ bike today?", opciones: ["by", "in", "at"], correcta: "by" },
    { pregunta: "The students are ______ the school bus.", opciones: ["in", "on", "by"], correcta: "on" },
    { pregunta: "My uncle travels ______ subway to work.", opciones: ["on", "in", "by"], correcta: "by" },
  ];
      ...
      {!finalizado ? (
        <>
          ...
          <section className="tarjeta-ejercicio" style={{ textAlign: "center", fontSize: "1.3rem", padding: "2rem" }}>
            ...
            >
              <p>{respuesta ? actual.pregunta.replace("______", opcionSeleccionada || "") : actual.pregunta}</p>
            </div>
